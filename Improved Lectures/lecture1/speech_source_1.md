...
This is not a theoretical exercise. Django's QuerySet works this way. Pandas DataFrames work this way. PyTorch tensors work this way. The biggest, most battle-tested Python projects in the world are built on exactly this principle.

### EXAMPLE 1.2

Let me show you a concrete example that makes this real. Imagine you are building an inventory management system. You have a collection of products, and you want this collection to behave like a native Python sequence.
...
Let us close with one of the most important ideas in Python, and one that separates Python from languages like Java or C++. Duck typing.
